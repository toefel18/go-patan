...
func (facade *Facade) StartStopwatch() Stopwatch {
    return startNewStopwatch()
}

func (facade *Facade) FindDuration(key string) (statistics.Distribution, bool) {
...
func (facade *Facade) FindSample(key string) (statistics.Distribution, bool) {
    return getOrEmpty(facade.store.samples, key)
}

func (facade *Facade) RecordElapsedTime(key string, stopwatch Stopwatch) int64 {
...
func (facade *Facade) Snapshot() statistics.Snapshot {
    return nil
}

func (facade *Facade) SnapshotAndReset() statistics.Snapshot {
    return nil
}
